## Hi-Res Audio™
 Enable High Resolution Audio in Audio_Policy config file for (Mediatek only) up to 32bit/192kHz & cuztomize audio channels like 24-channel (22.2) for audio output (Speaker & Wired).
